...
:: 生成的cs文件拷贝到scripts下
xcopy %binPath%%sheetName%.cs %csPath% /y
xcopy %binPath%%sheetName%_Item.cs %csPath% /y

move /y %binPath%%sheetName%.cs %scriptsPath%
move /y %binPath%%sheetName%_Item.cs %scriptsPath%
